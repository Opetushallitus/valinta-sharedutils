...
public enum ValintaperusteetOperation implements Operation{
    ...
    LASKENTATOTEUTUS_KAYNNISTYS,

    LASKENTATOTEUTUS_LUONTI,
    LASKENTATOTEUTUS_UUDELLEENLUONTI,
    LASKENTATOTEUTUS_PERUUTUS,
    ...
    HARKINNANVARAINEN_HYVAKSYMINEN_PAIVITYS,

    VALINTAKOE_POISTO,
    VALINTAKOE_PAIVITYS,

    VALINTAKOE_OSALLISTUMINEN_PAIVITYS,
